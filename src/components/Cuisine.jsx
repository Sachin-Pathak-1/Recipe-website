    ...
    return (
        <>
            <div className="sticky top-16 z-10  backdrop-blur-2xl bg-gray-900/80 border-b border-y-gray-800 shadow-inner shadow-black/20 max-w-8xl mx-auto px-4 lg:px-8 overflow-x-auto scrollbar-hide flex ">
                <div className="flex text-center items-center text-lg font-bold text-yellow-400 pr-3 whitespace-nowrap p-2">
                    <Globe className="mr-3" />Global Cuisines :
                </div>
                <div className="flex py-3 ">
                    {featuredAreas.map((country, i) =>
                                ...
                                <Link 
                                    to={`select/country`}
                                    className="bg-yellow-400 font-semibold rounded-xl py-1 px-4 text-black ml-3 flex text-center items-center">
                                    See More...
                                </Link>
                </div>
            </div>
